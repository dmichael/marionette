...
/*! \class Conductor
    ...
    retooled for customization by David M. Michael 2007
*/
/***************************************************/
#ifndef CONDUCTOR_H
#define CONDUCTOR_H
...
class Conductor : public Stk, public sigslot::has_slots<>
{
public:
  ...
  //! Create speaker objects based on how many channels are in the system
  ...
  */
  void addInstrument( Organism *instrument);
  
  void setVoicePosition(Conductor::Voice *voice);
  void setVoiceGains(Conductor::Voice *voice);
   ...
   */
  void removeInstrument( Organism *instrument );
  ...
  */
  ...
  // reference to a map of all anurans
  ...
  int number_of_channels; // this is a synonym for number_of_speakers since they mean basically the same thing
  
  // This is used to hold the last output of each voice tick(), and subsequently is constanly overwritten
